  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-white pb-12">
      <section className="relative overflow-hidden py-6 md:py-8">
        ...
        <div className="relative mx-auto max-w-6xl px-5 text-white md:px-10">
          <div className="relative mb-6 overflow-hidden rounded-[28px] border border-white/15 bg-white/10 px-6 py-5 shadow-[0_25px_80px_rgba(15,23,42,0.45)] backdrop-blur md:px-8">
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-sky-300/70 via-blue-400/70 to-indigo-400/70" aria-hidden />
            <div className="space-y-3 text-center md:text-left">
              <p className="text-xs uppercase tracking-[0.4em] text-sky-200">Dream Aquatics</p>
              <h1 className="text-[1.6rem] font-light leading-tight sm:text-[2.2rem] md:text-[2.6rem]">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative rounded-[28px] border border-white/10 bg-white/5 px-6 py-7 shadow-[0_25px_70px_rgba(15,23,42,0.45)] backdrop-blur lg:translate-y-4">
              <div className="space-y-4 text-center md:text-left">
                <p className="text-xs uppercase tracking-[0.3em] text-sky-200">Connect with us</p>
                <p className="text-lg font-semibold text-white">
                  Visit the studio, ask about care routines, or place orders directly with our team.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-4 rounded-[28px] border border-white/15 bg-white/10 p-6 text-center shadow-[0_25px_80px_rgba(15,23,42,0.35)] backdrop-blur lg:-translate-y-6">
