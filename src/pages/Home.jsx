          ...
          >
            {isSearchCollapsed ? (
              ...
              <div className="flex w-full max-w-4xl items-center gap-2 mx-auto">
                <div className="relative flex h-10 w-14 items-center justify-center rounded-xl border border-slate-200 bg-white">
          ...
          <div className="rounded-3xl bg-white/95 px-4 py-6 shadow-inner ring-1 ring-sky-100/60 backdrop-blur sm:px-6 lg:px-10">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                className="rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-wide text-slate-700 shadow hover:bg-slate-100"
              >
                Clear search
              </button>
            </div>
